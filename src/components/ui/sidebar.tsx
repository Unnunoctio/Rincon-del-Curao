            ...
            <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
                ...
                >
                    ...
                    <div className="flex h-full w-full flex-col px-3">
                        {/* Absorbe el foco automático del Sheet sin activar inputs */}
        ...
        >
            ...
            >
                <div
                    ...
                    className="flex size-full flex-col bg-background pl-3 pr-2 group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border"
                >
                    {children}
                </div>
            </div>
...
function SidebarHeader({ className, ...props }: React.ComponentProps<'div'>) {
    return <div data-slot="sidebar-header" data-sidebar="header" className={cn('flex flex-col gap-2 py-2', className)} {...props} />
}
